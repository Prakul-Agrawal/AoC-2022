...
def make_geode_robot(cur_state,cost):
    ...
    if req_time + cur_state.time <= 32:
        ...
        l[6] = cur_state.obs_rob
        l[7] = cur_state.time + req_time
        l[3] = cur_state.geode + 32 - cur_state.time - req_time
        if l[7] <= 30:
            return State(*l)
        elif l[3] > Max_geode:
            Max_geode = l[3]
